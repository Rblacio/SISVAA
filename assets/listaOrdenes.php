...
<body>
  ...
  <div class="container">
    <div class="row">
      <div class="col-6 mt-3"><h1 class="text-decoration-underline fw-bold">Listado de Ordenes de trabajo</h1></div>
      <div class="col-6 mt-4 text-end"><a href="./registroOrdenes.php">Crear registro</a></div>
    </div>
    <div class="mt-5 row justify-content-center align-items-center">
      ...
      <table class="table align-middle mb-0 bg-white">
        ...
        <?php
          ...
          $query = mysqli_query($conn, "SELECT o.idorden, o.cedulatecnico, u.nombres, o.cedulacliente, c.nombreCliente, o.titulOrden, o.costotrabajo, o.fechaasignacion, o.fechafinalizacion, t.Orden FROM ordentrabajo o INNER JOIN usuarios u ON (u.cedula = o.cedulatecnico) INNER JOIN clientes c ON (c.cedulaCliente = o.cedulacliente) INNER JOIN tipoorden t ON (t.idtipoOrden = o.idtipoorden) WHERE o.estado != 0 order by o.fechaasignacion ASC");
        ...
        <tbody>
          <tr class="text-center">
            ...
            <td>
              <div class="mb-2">
                <a href="./modificarOrden.php?id=<?php echo $row['idorden'] ?>" class="btn-rounded bg-warning text-white btn-sm fw-bold">Editar</a> <br>
              </div>
              <div class="mt-2">
                <a href="./eliminarOrden.php?id=<?php echo $row['idorden'] ?>" class="btn-rounded bg-danger text-white btn-sm fw-bold">Borrar</a>
              </div>
            </td>
          </tr>
        </tbody>
