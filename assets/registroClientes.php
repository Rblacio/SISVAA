          ...
          <div class="row">
            <div class="mt-3 col-md-6">
              <div class="form-outline">
                ...
                <input type="text" class="form-control" id="cedulaCliente" name="cedulaCliente" placeholder="Cédula">
                <label for="cedulaCliente" id="cedulaCliente" class="form-label text-black fw-bold">Cédula</label>
              </div>
            </div>
            <div class="mt-3 col-md-6">
              <div class="form-outline">
